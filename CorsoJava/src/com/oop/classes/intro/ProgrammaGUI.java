...
public class ProgrammaGUI extends JFrame {
    ...
    @SuppressWarnings("unused")
	private AnagraficaPanel anagraficaPanel;
    public ProgrammaGUI() {
        ...
        tabbedPane.addTab("Home", settingsPanel);
        // ---------------- NUMERI ----------------
        ...
        tabbedPane.addTab("Eccezioni", excPanel);
	     // ---------------- ANAGRAFICA & BANK ACCOUNT & VEICOLI ----------------
	     // Crea una singola istanza di AnagraficaManager
	     AnagraficaManager anagraficaManager = new AnagraficaManager();
	
	     // Crea i pannelli e passa il manager
	     AnagraficaPanel anagraficaPanel = new AnagraficaPanel(anagraficaManager);
	     List<Veicolo> veicoliDisponibili = new ArrayList<>();
	     CreaVeicoloPanel creaVeicoloPanel = new CreaVeicoloPanel(veicoliDisponibili);
	     CompraVeicoloPanel compraVeicoloPanel = new CompraVeicoloPanel(anagraficaManager, veicoliDisponibili);
	     
	     // Aggiungi il listener per il salvataggio quando la finestra si chiude
	  ...
	  // Aggiungi un ChangeListener al JTabbedPane
	     tabbedPane.addChangeListener(e -> {
	         // Controlla se la tab "Compra Veicolo" è stata selezionata
	         if (tabbedPane.getSelectedComponent() instanceof CompraVeicoloPanel) {
	             // Richiama il metodo per aggiornare la lista
	             compraVeicoloPanel.aggiornaListe();
	         }
	     });
	     
	
	     // Aggiungi le tab al JTabbedPane
	     tabbedPane.addTab("Crea Veicolo", creaVeicoloPanel);
	     tabbedPane.addTab("Compra Veicolo", compraVeicoloPanel);
	     tabbedPane.addTab("Anagrafica", anagraficaPanel);
        // ---------------- DIPENDENTE ----------------
...
//        tabbedPane.addTab("Dipendente", dipPanel);
    ...
    class CheckingAccount extends AccountProperties {
